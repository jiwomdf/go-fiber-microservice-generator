...
import (
	...
	_DeliveryHTTP "auth-service/data/delivery/http"
	_Repo "auth-service/data/repository/postgres"
	_Usecase "auth-service/data/usecase"
...
func registerRoutes(app *fiber.App, db *gorm.DB) {
	...
	repo := _Repo.NewAuthRepo(db)
	usecase := _Usecase.NewAuthUsecase(repo)
